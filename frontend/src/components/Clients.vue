    ...
    <v-layout>
      <v-flex xs12>
        <v-card>
          ...
          <v-card-text>
            <v-data-table :headers="headers" :items="clientdblist" :search="search" :rows-per-page-items="rowsPerPage">
...
<script>
  export default {
    data() {
      return {
        headers: [
          {text: 'Last Nickname', value: 'client_nickname'},
          {text: 'Unique Identifier', value: 'client_unique_identifier'},
          {text: 'Created', value: 'client_created'},
          {text: 'Last', value: 'client_lastconnected'},
          {text: 'Total', value: 'client_totalconnections'},
          {text: 'Last IP', value: 'client_lastip'},
          {text: 'Description', value: 'client_description'},
